...
public class RequestLogger {
  ...
  public void logRequest(BufferedRequestWrapper bufferedRequest) throws IOException {
    ...
    if(!bufferedRequest.getRequestBody().contains("xlsx") && !bufferedRequest.getRequestBody().contains("csv") && !bufferedRequest.getRequestBody().contains("zip")&& !bufferedRequest.getRequestBody().contains("pdf"))
  ...
  public void logResponse(BufferedResponseWrapper bufferedResponse, long totalRequestTime) {
    ...
    if(!responseHeaders.contains("xlsx") && !responseHeaders.contains("csv") && !responseHeaders.contains("zip") && !responseHeaders.contains("pdf"))
